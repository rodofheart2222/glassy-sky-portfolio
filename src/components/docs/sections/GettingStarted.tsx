      ...
      <div className="space-y-8 text-white/90">
        ...
        <div>
          ...
          <ol className="list-decimal pl-6 space-y-2">
            <li><strong>Join Our Discord Server</strong>: If you haven't already, join our <a href="https://discord.gg/u6qrhwnBs6" className="text-blue-400 hover:text-blue-300 underline transition-colors">Discord Server</a> where the admin team manages RPC endpoint allocations.</li>
