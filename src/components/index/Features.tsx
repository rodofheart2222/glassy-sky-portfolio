    ...
    <section className="py-32">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          ...
          <p className="text-xl font-extrabold text-white/90 max-w-3xl mx-auto leading-relaxed glow-text">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glass-effect-card p-8 hover-scale shadow-2xl hover:shadow-[#8B5CF6]/30"
            >
              <div className="w-16 h-16 bg-[#8B5CF6]/10 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-[#8B5CF6]/20">
                {feature.icon}
              </div>
