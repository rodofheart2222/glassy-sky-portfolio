...
export const Hero = ({ setShowDepositDialog }: { setShowDepositDialog: (show: boolean) => void }) => {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <span className="inline-block px-6 py-2 mb-6 text-lg font-black rounded-full bg-[#8B5CF6]/20 text-[#8B5CF6] border-2 border-[#8B5CF6]/20 shadow-lg shadow-[#8B5CF6]/20 hover:shadow-[#8B5CF6]/30 transition-shadow">
        ...
        <div className="flex items-center justify-center gap-6">
          <Button 
            className="px-8 py-6 border-2 border-[#8B5CF6] bg-[#8B5CF6]/10 hover:bg-[#8B5CF6]/20 text-white rounded-full font-black text-lg shadow-xl shadow-[#8B5CF6]/20 hover:shadow-[#8B5CF6]/30 transform hover:scale-105 transition-all backdrop-blur-sm"
