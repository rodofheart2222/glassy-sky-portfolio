            ...
            >
              <div className="h-64 relative">
                ...
                <div className="absolute bottom-0 left-0 w-full h-1/2 flex items-end">
                  <div className="w-full h-[2px] bg-gradient-to-r from-[#F97316] to-[#F97316]/50 relative">
                    <div className="absolute -top-3 left-0 text-sm text-[#F97316]">Our RPC</div>
                    <div className="absolute top-0 left-0 w-2 h-2 rounded-full bg-[#F97316] shadow-lg shadow-[#F97316]/50" />
                  </div>
                </div>

                {/* Slow Line (Other Providers) */}
                <div className="absolute bottom-0 left-0 w-full h-full flex items-end">
                  <div className="w-full h-[2px] bg-gradient-to-r from-white/40 to-white/20 relative transform translate-y-12">
                    <div className="absolute -top-3 left-0 text-sm text-white/60">Other Providers</div>
                    <div className="absolute top-0 left-0 w-2 h-2 rounded-full bg-white/60" />
                  </div>
                </div>
              </div>
            </motion.div>
